 ...
 */
declare function scale(width?: number | string, height?: number | string): ScaleAction;
/**
 * @summary action
 * @description
 ...
 * @return {Actions.Resize.ResizeFillAction}
 */
declare function limitFill(width?: string | number, height?: string | number): ResizeFillAction;
/**
 * @summary action
 * @description
 ...
 * @return {Actions.Resize.ResizeSimpleAction}
 */
declare function limitFit(width?: number | string, height?: number | string): ResizeSimpleAction;
/**
 * @summary action
 * @description
 ...
 * @return {Actions.Resize.ResizePadAction}
 */
declare function minimumPad(width?: string | number, height?: string | number): ResizePadAction<CompassGravity>;
/**
 * @summary action
 * @description
 * Resizes the asset so that it takes up as much space as possible within a bounding box defined by the given
 ...
 * @return {Actions.Resize.ResizePadAction}
 */
declare function limitPad(width?: string | number, height?: string | number): ResizePadAction<CompassGravity>;
