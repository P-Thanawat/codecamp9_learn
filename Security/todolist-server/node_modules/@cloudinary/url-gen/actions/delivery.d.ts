...
export declare type IDeliveryAction = DeliveryAction | DeliveryColorSpaceFromICC;
/**
 * @summary action
 ...
 *
 */
declare function format(format: FormatQualifier | ImageFormatType | VideoFormatType | string): DeliveryFormat;
/**
 * @summary action
 ...
 * );
 */
declare function dpr(dpr: string | number): DeliveryAction;
/**
 * @summary action
 ...
 * );
 */
declare function colorSpace(mode: ColorSpaceType | string): DeliveryAction;
/**
 * @summary action
 ...
 * );
 */
declare function colorSpaceFromICC(publicId: string): DeliveryColorSpaceFromICC;
